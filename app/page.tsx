        ...
        <>
            ...
            <main className="font-sans">
                ...
                <section className="relative min-h-screen bg-[#5772FD] flex flex-col items-center justify-center px-4 text-center overflow-hidden">
                    ...
                    >
                        Empowering students to connect with top employers and launch their careers.
                    </motion.p>
                    <motion.a
                ...
                <section className="py-20 bg-white">
                    <div className="max-w-6xl mx-auto px-4">
                        ...
                        >
                            We provide the tools and resources you need to succeed in today’s competitive job market.
                        </motion.p>
                        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
                            ...
                            >
                                <img src="/feature-verified.svg" alt="Verified Employers" className="w-16 h-16 mb-4" />
                                <h3 className="text-xl font-semibold text-[#5772FD]">Verified Employers</h3>
                                <p className="mt-2 text-gray-600">
                                    Connect with trusted employers actively seeking student talent.
                                </p>
                            </motion.div>
                            {/* Feature Card 2 */}
                            <motion.div
                                ...
                                className="flex flex-col items-center text-center p-6 shadow-lg rounded-lg hover:shadow-2xl transition"
                            >
                                <img src="/feature-matches.svg" alt="Tailored Job Matches" className="w-16 h-16 mb-4" />
                                <h3 className="text-xl font-semibold text-[#5772FD]">Tailored Job Matches</h3>
                                <p className="mt-2 text-gray-600">
                                    Get matched with job opportunities that fit your skills and career goals.
                                </p>
                            </motion.div>
                            {/* Feature Card 3 */}
                            <motion.div
                                ...
                                className="flex flex-col items-center text-center p-6 shadow-lg rounded-lg hover:shadow-2xl transition"
                            >
                                <img src="/feature-career.svg" alt="Career Resources" className="w-16 h-16 mb-4" />
                                <h3 className="text-xl font-semibold text-[#5772FD]">Career Resources</h3>
                                <p className="mt-2 text-gray-600">
                        ...
                        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div className="space-y-12">
                                ...
                                >
                                    ...
                                    />
                                    <div>
                                        <h3 className="text-2xl font-semibold text-[#5772FD]">Sign Up</h3>
                                        <p className="mt-2 text-gray-700">
                                            Create your profile with your details and resume to get started.
                                        </p>
                                    </div>
                                </motion.div>
                                {/* Step 2 */}
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-2 text-gray-700">
                                            Showcase your skills, experiences, and portfolio to stand out.
                                        </p>
                                    </div>
                                </motion.div>
                                {/* Step 3 */}
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-2 text-gray-700">
                                            Secure your position and kickstart your professional journey.
                                        </p>
                                    </div>
                                </motion.div>
                                {/* Step 5 */}
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-2 text-gray-700">
                                            Engage with industry professionals and expand your connections.
                                        </p>
                                    </div>
                                </motion.div>
                            </div>
                        ...
                        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
                            ...
                            >
                                <p className="text-gray-600 italic">
                                    "This platform helped me land an amazing internship. The job matches were spot on!"
                                </p>
                                <p className="mt-4 font-semibold text-[#5772FD]">- Alex, Student</p>
                            </motion.div>
                            {/* Testimonial Card 2 */}
                            <motion.div
                                initial={{ opacity: 0, y: 50 }}
                            ...
                            >
                                <p className="text-gray-600 italic">
                                    "We found several talented students through this platform. Highly recommended!"
                                </p>
                                <p className="mt-4 font-semibold text-[#5772FD]">- Jamie, Employer</p>
                            </motion.div>
                            {/* Testimonial Card 3 */}
                            <motion.div
                                initial={{ opacity: 0, y: 50 }}
                            ...
                            >
                                <p className="text-gray-600 italic">
                                    "A game-changer for students and employers alike. It truly bridges the gap."
                                </p>
                                <p className="mt-4 font-semibold text-[#5772FD]">- Morgan, Student</p>
                            </motion.div>
                        </div>
                    </div>
                </section>
                ...
                <section className="py-20 bg-[#5772FD] flex flex-col items-center text-center px-4">
                    ...
                    >
                        Join our community today and connect with top employers to jumpstart your career.
                    </motion.p>
                    <motion.a
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.95 }}
